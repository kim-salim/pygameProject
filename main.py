...
image_background=pygame.transform.scale(pygame.image.load("galaxy_background.jpg"),(1000,600))
spaceship_image=pygame.transform.scale(pygame.image.load("spaceship.jpg"),(300,200))
...
def main():
    ...
    while True:
        ...
        message_Title = Big_font.render("SHOOTING_GAME", True, (255, 255, 255))  # 게임제목 적기
        ...
        SURFACE.fill((0, 0, 0))
        SURFACE.blit(spaceship_image, (0, 400))
        ...
        if  game_start:
            ...
            '''SURFACE.BLIT(ship_image,(100,100))'''
